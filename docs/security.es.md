...
| El análisis estático bloquea el cambio que introduce el hallazgo | CodeQL (`security-extended`) en cada pull request para Python, JavaScript/TypeScript, Rust y los workflows, más una pasada completa semanal (`.github/workflows/codeql.yml`) | `test_codeql_workflow.py` |
