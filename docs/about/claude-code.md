...
description: "Claude Code is a coding agent for developers. AgenticOS is where the agents for the rest of the company run, and Claude Code can help build them."
---
