...
| `make lint` | Every static check: ruff, ruff format, ty, vulture, eslint, prettier, tsc, the guard scripts (backtick, i18n, routes, banner comments), knip's dependency check, and codespell over the whole tree |
