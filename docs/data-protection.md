...
| Your SMTP relay | Invitations, magic links, approval requests, budget alerts, usage reports | Whatever the relay keeps. Approval mail names the agent, the tool and a link, not the tool's arguments |
