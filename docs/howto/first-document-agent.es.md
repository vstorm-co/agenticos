...
1. Crea una colección en **Knowledge → Collections** y sube el archivo. Espera al procesamiento y comprueba el estado.
...
Cambia el responsable a facilities team, sustituye la fuente mediante el [flujo de colecciones](../file-processing.md), espera al procesamiento y repite en otra conversación. Comprueba que no se sigue recuperando material obsoleto.
