...
1. Erstellen Sie unter **Knowledge → Collections** eine Sammlung und laden Sie die Datei hoch. Warten Sie auf die Verarbeitung und prüfen Sie den Dokumentstatus.
...
Ändern Sie die Zuständigkeit auf facilities team, ersetzen Sie die Quelle über den [Sammlungsablauf](../file-processing.md), warten Sie auf die Verarbeitung und wiederholen Sie in einer neuen Konversation. Prüfen Sie, dass keine veraltete Quelle mehr abgerufen wird.
