...
Agents, collections, skills, context files, vault secrets and artifacts each get the same four routes,
...
from app.services.access import AGENT, ARTIFACT, COLLECTION, CONTEXT, SECRET, SKILL
