...
Agents, collections, skills, context files and vault secrets each get the same four routes,
...
from app.services.access import AGENT, COLLECTION, CONTEXT, SECRET, SKILL
