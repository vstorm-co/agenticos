...
* :func:`verify_signature` - is this delivery authentic? Both sources sign the raw
  ...
  `X-Signature-256` an email relay is configured to send). The comparison is
...
# own native header; email reuses the same scheme under a header a relay sets.
_SIGNATURE_HEADER = {
