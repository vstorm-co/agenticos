...
EXEMPT: dict[str, str] = {
    ...
    "tests/test_embedding_resolution.py::TestCredentialDegradation::test_a_deleted_secret_falls_back_to_the_deployment_key": "a deleted embedding secret falls back to the deployment key, degradation, no refusal",
    "tests/test_embedding_resolution.py::TestCredentialDegradation::test_a_secret_of_the_wrong_kind_falls_back": "a wrong-kind embedding secret falls back, degradation, no refusal",
