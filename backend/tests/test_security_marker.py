...
EXEMPT: dict[str, str] = {
    ...
    "tests/integration/test_audit_hash_chain.py::TestTheDeploymentChain::test_a_tenant_less_write_chains_and_verifies": "the deployment-wide (organization_id=None) chain writes and verifies, feature, no refusal",
