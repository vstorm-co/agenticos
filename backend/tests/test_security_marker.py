...
EXEMPT: dict[str, str] = {
    ...
    "tests/integration/test_notification_center.py::TestMandatoryEvents::test_a_burst_past_the_budget_coalesces_into_one_row": "'budget' names the same rate-limit allowance; a burst past it is coalesced rather than refused",
    ...
    "tests/test_notifications.py::TestApprovalRequested::test_many_approvals_parked_at_once_fit_the_occurrence_id_column": "a hashed occurrence id fits the notifications column at scale, storage correctness, no refusal",
    ...
    "tests/test_workflow_execution_budget.py::TestOverBudget::test_no_limit_is_never_over_budget": "pure threshold arithmetic on a workflow run's spend cap, no refusal",
    "tests/test_workflow_execution_budget.py::TestOverBudget::test_spend_under_the_limit_is_not_over": "pure threshold arithmetic, no refusal",
    "tests/test_workflow_execution_budget.py::TestOverBudget::test_spend_at_the_limit_is_over": "pure threshold arithmetic, no refusal",
    "tests/test_workflow_execution_budget.py::TestOverBudget::test_spend_past_the_limit_is_over": "pure threshold arithmetic, no refusal",
    "tests/test_workflow_execution_budget.py::TestPastDeadline::test_no_deadline_is_never_past": "pure deadline arithmetic, no refusal",
    "tests/test_workflow_execution_budget.py::TestPastDeadline::test_before_the_deadline_is_not_past": "pure deadline arithmetic, no refusal",
    "tests/test_workflow_execution_budget.py::TestPastDeadline::test_at_the_deadline_is_past": "pure deadline arithmetic, no refusal",
    "tests/test_workflow_execution_budget.py::TestPastDeadline::test_after_the_deadline_is_past": "pure deadline arithmetic, no refusal",
