...
EXEMPT: dict[str, str] = {
    ...
    "tests/integration/test_virtual_table_retention.py::test_the_table_sweep_budget_scales_with_the_write_rate_setting": "retention sweep batch budget, not a security refusal, keyword coincidental",
