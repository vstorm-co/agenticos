...
Revision ID: 0047_agent_event_triggers
Revises: 0046_agent_triggers
...
An event trigger carries an `event_source` (`github`, `email`, or the
...
revision = "0047_agent_event_triggers"
down_revision = "0046_agent_triggers"
branch_labels = None
depends_on = None
