...
Revision ID: 0029_agent_event_triggers
Revises: 0028_agent_triggers
Create Date: 2026-08-11

`0028` gave `agent_triggers` one shape: a clock schedule (interval or cron). This
...
The downgrade is real but lossy by necessity: the pre-0029 schema has no concept of
...
revision = "0029_agent_event_triggers"
down_revision = "0028_agent_triggers"
branch_labels = None
depends_on = None

# The 0028 shape check, restored on downgrade. Kept as a constant so the
