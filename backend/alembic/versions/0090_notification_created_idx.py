...
Revision ID: 0090_notification_created_idx
Revises: 0089_run_publisher_fallback
...
revision: str = "0090_notification_created_idx"
down_revision: str | None = "0089_run_publisher_fallback"
