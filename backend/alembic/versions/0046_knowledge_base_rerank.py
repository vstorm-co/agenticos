...
Revision ID: 0046_knowledge_base_rerank
Revises: 0045_audit_impersonator
...
revision: str = "0046_knowledge_base_rerank"
down_revision: str | None = "0045_audit_impersonator"
