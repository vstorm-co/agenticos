...
Revision ID: 0073_agent_memory_fact_origin
Revises: 0072_agent_memory_facts
...
revision: str = "0073_agent_memory_fact_origin"
down_revision: str | None = "0072_agent_memory_facts"
