...
Renumbered from 0081 alongside 0088_notification_center_schema's own move - see
that migration's docstring for why the stack's numbering had to follow main's.
"""
...
revision: str = "0089_run_publisher_fallback"
down_revision: str | None = "0088_notification_center_schema"
